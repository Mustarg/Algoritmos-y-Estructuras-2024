from lista import search, by_name, by_house, remove, show_list
...
print(remove( super_heroes, "nombre","Linterna Verde"))

print(super_heroes[search(super_heroes, "nombre", "Wolverine")]["año_aparicion"])

super_heroes[search(super_heroes, "nombre", "Doctor Strange")]["casa_comic"] = "Marvel"
#print(super_heroes[search(super_heroes, "nombre", "Doctor Strange")])
...
print("Capitana Marvel pertenece a:", super_heroes[search(super_heroes, "nombre", "Capitana Marvel")]["casa_comic"])
print("Mujer Maravilla pertenece a:", super_heroes[search(super_heroes, "nombre", "Mujer Maravilla")]["casa_comic"])
print(super_heroes[search(super_heroes, "nombre", "Flash")])
print(super_heroes[search(super_heroes, "nombre", "Star-Lord")])
...
for heroe in super_heroes:
    if heroe["casa_comic"] == "DC Comics":
        ...
        heroesMarvel+=1
print("Heroes DC:", heroesDC, "Heroes Marvel:", heroesMarvel)
